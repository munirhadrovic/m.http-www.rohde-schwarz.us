...
<html>
	<head>
		...
		<title>Rohde & Schwarz - Rohde & Schwarz USA</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://rohde-schwarz.us/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      ...
				      <li>
				        <img src="img/slider-images/slider6.png" alt="">
				        <!-- <p class="caption">The third caption</p> -->
				      </li>
				    </ul>
			    </div>
			...
			<!-- <div data-role="collapsible-set">	
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Products</a>
                  </div>
              </div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Solutions</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Service & Support</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Popular Topics</a>
					</div>
				</div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Products</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Solutions</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Service & Support</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Popular Topics</a></li>					
